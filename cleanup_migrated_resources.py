...
# 리소스 목록 미리보기
# ===================================================
def preview_resources(lambda_src, sfn_src, events_src) -> dict:
    """삭제될 리소스 목록 미리보기"""
...
def main():
    ...
    try:
        # 리소스 미리보기
        resources = preview_resources(lambda_src, sfn_src, events_src)
